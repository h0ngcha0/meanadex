...
(function() {
  ...
  describe('Tshirts Controller Tests', function() {
    ...
    it('$scope.find() should create an array with at least one Tshirt object fetched from XHR', inject(
      function(Tshirts) {
    ...
    it('$scope.findOne() should create an array with one Tshirt object fetched from XHR using a tshirtId URL parameter', inject(
      function(Tshirts) {
    ...
    it('$scope.remove() should send a DELETE request with a valid tshirtId and remove the Tshirt from the scope', inject(
      function(Tshirts) {
