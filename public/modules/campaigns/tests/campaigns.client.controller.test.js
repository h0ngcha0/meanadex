...
//        $location;
//
//    // The $resource service augments the response object with
//    // methods for updating and deleting the resource.
//    // If we were to use the standard toEqual matcher, our tests
//    //  would fail because the test values would not match
//    // the responses exactly. To solve the problem, we define a
//    //  new toEqualData Jasmine matcher. When the toEqualData matcher
//    //  compares two objects, it takes only object properties into
...
//    );
//
//    it('$scope.find() should create an array with at least one Campaign object fetched from XHR', inject(
//      function(Campaigns) {
...
//    );
//
//    it('$scope.findOne() should create an array with one Campaign object fetched from XHR using a campaignId URL parameter', inject(
//      function(Campaigns) {
...
//    );
//
//    it('$scope.update() should update a valid Campaign', inject(
//      function(Campaigns) {
...
//    );
//
//    it('$scope.remove() should send a DELETE request with a valid campaignId and remove the Campaign from the scope', inject(
//      function(Campaigns) {
