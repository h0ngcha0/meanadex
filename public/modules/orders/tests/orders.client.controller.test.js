...
(function() {
  ...
  describe('Orders Controller Tests', function() {
    ...
    it('$scope.find() should create an array with at least one Order object fetched from XHR', inject(
      function(Orders) {
    ...
    it('$scope.findOne() should create an array with one Order object fetched from XHR using a orderId URL parameter', inject(
      function(Orders) {
    ...
    it('$scope.update() should update a valid Order', inject(
      function(Orders) {
    ...
    it('$scope.remove() should send a DELETE request with a valid orderId and remove the Order from the scope', inject(
      function(Orders) {
